    ...
    def __init__(self, hparams, **kwargs):
        ...
        if 't5' in hparams.model_name_or_path:
           # self.model.config.prefix = 'translate Graph to English: '
            self.model.config.prefix = 'predict masked spans: '
  ...
  #  else:
   ...
   #         data_logs = {}
     ...
     #   val_outputs_folder = "val_outputs"
      ...
      #  for outputs in outputs_all_testsets:
       ...
       #         file_name = "test_predictions.txt"
        #        file_name_tgt = "test_targets.txt"
         #       dataset_name = 'test'
    ...
    def test_dataloader(self) -> List[DataLoader]:
        test_dataloader = self.get_dataloader("test", batch_size=self.hparams.eval_batch_size)
