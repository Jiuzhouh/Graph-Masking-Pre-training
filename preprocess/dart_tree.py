...
outdir = 'data/dart_pos_ordered'
b = Benchmark()
files = [('dart_v1.1.1/train', 'dart_v1.1.1_full_train.xml')]
...
b = Benchmark()
files = [('dart_v1.1.1/dev', 'dart_v1.1.1_full_dev.xml')]
b.fill_benchmark(files)
...
b = Benchmark()
files = [('dart_v1.1.1/test', 'dart_v1.1.1_full_test.xml')]
b.fill_benchmark(files)
